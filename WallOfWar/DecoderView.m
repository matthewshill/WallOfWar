...
-(void)setUpIconTrays{
    ...
    [self addSubview:_categoryIconTray];
    ...
    [self addSubview:_attackOnIconTray];
    ...
    [self addSubview:_regionIconTray];
    ...
    [self addSubview:_friendlyLabel];
...
-(void)setUpResultsBox{
    ...
    [self addSubview:_friendlyResultLabel];
    ...
    [self addSubview:_friendlyResultLabel2];
    ...
    [self addSubview:_civilianResultLabel];
    ...
    [self addSubview:_civilianResultLabel2];
    ...
    [self addSubview:_enemyResultLabel];
    ...
    [self addSubview:_enemyResultLabel2];
}
-(void) performQuery {
...
-(void)touchesEnded:(NSSet *)touches withEvent:(UIEvent *)event{
    ...
    if (CGRectContainsPoint(_typeIconTray.frame, touch) && (!categoryExpanded && !regionExpanded && !typeExpanded && !typeIconSelected)) {
        ...
        //newFrame.size.width += (width * 0.3627);
        //newFrame.size.height += (width * 0.3627);
        ...
        [UIView animateWithDuration:0.3
                         animations:^{
                             ...
                             [self bringSubviewToFront:_ewiaIconTray];
                         }];
        ...
        [UIView animateWithDuration:0.3
                         animations:^{
                             ...
                             [self bringSubviewToFront:_ekiaIconTray];
                         }];
...
-(void)displayWoKIcons:(UIView *)wOkView{
    ...
    UIImageView *icon;
    for (int i=0; i<5; i++) {
        CGRect iconFrame = CGRectMake(wOkView.frame.origin.x, (wOkView.frame.origin.y - (SCREEN_HEIGHT *0.02) + (SCREEN_HEIGHT * (0.0438 * i))) + statusBarHeight, width * 0.1316, SCREEN_HEIGHT * 0.0438);
...
-(void)selectedIcon:(int)i{
    if (typeExpanded) {
        ...
        [self addSubview:selectedTypeIcon];
        //[self addSubview:img];
        ...
        [self addSubview:selectedCatIcon];
        //[self addSubview:img];
        ...
        [self addSubview:selectedRegionIcon];
        ...
        [self addSubview:selectedEkiaIcon];
        ekiaExpanded = false;
        wOkQuery = true;
    }
        ...
        [self addSubview:selectedEwiaIcon];
        ewiaExpanded = false;
        wOkQuery = true;
    }
        ...
        [self addSubview:selectedCwiaIcon];
        cwiaExpanded = false;
        wOkQuery = true;
    }
        ...
        [self addSubview:selectedCkiaIcon];
        ckiaExpanded = false;
        wOkQuery = true;
    }
        ...
        [self addSubview:selectedFwiaIcon];
        fwiaExpanded = false;
        wOkQuery = true;
    }
    else{
        ...
        [self addSubview:selectedFkiaIcon];
        fkiaExpanded = false;
        wOkQuery = true;
    }
}
-(void)setAttackIcon{
    //CGRect frame = CGRectMake(width * 0.5572, SCREEN_HEIGHT * 0.0708 + statusBarHeight, width * 0.18375, SCREEN_HEIGHT * 0.0657);
    CGRect frame = CGRectMake(width * 0.5125, SCREEN_HEIGHT * 0.0608 + statusBarHeight, width * 0.244, SCREEN_HEIGHT * 0.0657);
    ...
    [self addSubview:selectedAttackIcon];
